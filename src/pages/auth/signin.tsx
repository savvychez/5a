  ...
  return (
    <>
        <div className="login-container flex text-md xl:text-lg min-h-screen flex-col items-center justify-center">
            ...
            <div className="white-box bg-acid-white max-h-96 overflow-x-hidden px-4 py-4 xl:px-6 xl:py-6 rounded-md shadow-2xl scroll-shadow">
                  <h1 className="bg-acid-white pb-4 "><strong>5a | </strong>login with your preferred provider</h1>
                  {
                  /* eslint-disable @typescript-eslint/no-misused-promises */
                  Object.values(providers).map((provider) => (
                      <div key={provider.name}>
                      <button className="bg-acid-green w-full my-2 py-3 rounded-xl border-2 border-acid-black hover:bg-acid-darkened-green " onClick={() => 
                          signIn(provider.id)}>
